...
liam = Student.create(first_name: "Liam", last_name: "Smith", age: 13, siblings: true)	
...
liam = Student.create(first_name: "Liam", last_name: "Smith", age: 6, siblings: true)	
oliver = Student.create(first_name: "Oliver", last_name: "Anderson", age: 17, siblings: false)		
...
sophia = Student.create(first_name: "Sophia", last_name: "Gonçalves", age: 12, siblings: false)	
...
liam = Student.create(first_name: "Liam", last_name: "Smith", age: 16, siblings: true)	
charlotte = Student.create(first_name: "Charlotte", last_name: "Lee", age: 6, siblings: false)	
benjamin = Student.create(first_name: "Benjamin", last_name: "Wong", age: 7, siblings: false)		
amelia = Student.create(first_name: "Amelia", last_name: "Kim", age: 8, siblings: false)	
liam = Student.create(first_name: "Liam", last_name: "Smith", age: 9, siblings: true)	
lucas = Student.create(first_name: "Lucas", last_name: "Lopez", age: 10, siblings: false)		
mia = Student.create(first_name: "Mia", last_name: "Silva", age: 11, siblings: false)	
liam = Student.create(first_name: "Liam", last_name: "Smith", age: 12, siblings: true)	
